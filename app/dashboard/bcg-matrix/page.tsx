    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b">
        <div className="px-6 py-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">BCG Matrix Analysis</h1>
              <p className="text-gray-600">Strategic portfolio analysis for your product lineup</p>
            </div>
          </div>
      ...
      <div className="p-6">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 h-96">
              {/* Axis Labels */}
              <div className="absolute left-4 top-1/2 -translate-y-1/2 -rotate-90 text-sm font-medium text-gray-600">
                Market Growth Rate (%)
              </div>
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-sm font-medium text-gray-600">
              ...
              <div className="absolute inset-8 border-l-2 border-b-2 border-gray-300">
                ...
                <div className="absolute left-1/2 top-0 bottom-0 border-l border-gray-200"></div>
              </div>
